 ...
 * any static server. The Mermaid UMD bundle is inlined by the renderer
 * (md2html ships it via node_modules/mermaid); a CDN fallback exists for
 * renders made without the bundle present.
 *
...
(function () {
  ...
  if (!mermaid) {
    // Fallback when the inlined bundle is absent (e.g. manual render).
